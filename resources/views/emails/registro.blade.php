    ...
    <div class="container">
        <table width="100%">
            <tr>
                ...
                <td style="text-align: center;">
                    <h1 style="font-size: 24px; color: rgb(14, 162, 176);">Registro</h1>
                </td>
            </tr>
        </table>
        <h2 style="font-size: 20px; color: rgb(14, 162, 176);">{{$data['nombre']}} {{$data['apellido']}}, Se ha registrado de forma correcta. Gracias!</h2>
        <p style="font-size: 16px; color: rgb(7, 87, 94);">Ahora puedes completar la informacion de tus servicios y gestionar tus citas.</p>
